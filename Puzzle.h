...
//const int NUMBER_OF_SQUARES = 81;
...
public:
    ...
    * value in the current block, false otherwise
	*/
	bool isBlockLegal(int x, int y, int value);
	...
	* in the current row, false otherwise
	*/
	bool isRowLegal(int y, int value);
	...
	* in the current column, false otherwise
	*/
	bool isColumnLegal(int x, int value);
